        ...
        <div className="w-full max-w-md">
          <div className="bg-white rounded-2xl shadow-xl p-8">
            ...
            <div className="text-center mb-8">
              ...
              <p className="text-gray-500 mt-2">Sign in to your EcoStay Connect account</p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <button
                type="submit"
                className="w-full py-3 bg-green-700 text-white font-bold text-lg rounded-lg hover:bg-green-800 transition-colors shadow-md hover:shadow-lg cursor-pointer"
              >
                Sign In
              </button>
            </form>
            ...
            <div className="grid grid-cols-2 gap-4">
              <button className="flex items-center justify-center px-4 py-3 border border-gray-300 rounded-lg hover:bg-gray-50 transition-colors cursor-pointer">
